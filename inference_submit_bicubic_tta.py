#!/usr/bin/env python3
"""
Run inference with bicubic warping + TTA horizontal flip.

Same as inference_submit_bicubic.py but adds test-time augmentation:
averages flow from original + horizontally flipped input for more
symmetric, accurate corrections. ~2x inference time.
"""
import zipfile
...
_OUTPUT_DIR = _SCRIPT_DIR / "submission_images_bicubic_tta"
_ZIP_PATH = _SCRIPT_DIR / "submission_bicubic_tta.zip"
...
def main():
    ...
    print(f"Corrected {n} images (bicubic + TTA) -> {_OUTPUT_DIR}")
